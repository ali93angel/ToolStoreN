...
public class CartActivity extends BaseActivityDrawer {
    ...
    protected void initialize() {
        ...
        View childLayout = Objects.requireNonNull(inflater).inflate(R.layout.cart_activity, findViewById(R.id.cart_activity));
